...
import { CheckCircle, Globe, AlertTriangle, ArrowRight } from "lucide-react"
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              <div className="lg:w-2/3 space-y-8">
                <div className="prose prose-invert max-w-none">
                  <h2 className="text-3xl font-bold text-white">Basic Web Application Security Assessment</h2>
                  <p className="text-muted-foreground text-lg">
                    At Step Stone Security, we use freely available tools to perform a basic assessment of your web
                    application's security posture. This initial review helps us identify potential vulnerabilities and
                  ...
                  <p className="text-muted-foreground text-lg">
                    We utilize industry-standard open-source security scanning tools to analyze your web applications
                    for common security issues such as:
                  </p>
                  <ul className="space-y-2 my-6">
                    ...
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">Cross-site request forgery (CSRF)</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">Authentication and session management flaws</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">Security misconfigurations</span>
                    </li>
                  </ul>
                  ...
                  <ul className="space-y-2 my-6">
                    <li className="flex items-start">
                      <Globe className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">OWASP ZAP for vulnerability scanning</span>
                    </li>
                    <li className="flex items-start">
                      <Globe className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">Burp Suite Community Edition</span>
                    </li>
                    <li className="flex items-start">
                      <Globe className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">OWASP Top 10 checklist</span>
                    </li>
                    <li className="flex items-start">
                      <Globe className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">Browser developer tools</span>
                    </li>
                    <li className="flex items-start">
                      <Globe className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">Content Security Policy analyzers</span>
                    </li>
                  </ul>
                </div>
              </div>
              <div className="lg:w-1/3 space-y-8">
                <div className="bg-darkblue p-6 rounded-lg border border-muted sticky top-24">
                  <h3 className="text-xl font-bold text-white mb-4">Ready to secure your web application?</h3>
                  <p className="text-muted-foreground mb-6">
                    Subscribe to our fractional cybersecurity team and get expert web application security assessment
                    and advice.
                  </p>
                  ...
                  <div className="mt-6 pt-6 border-t border-muted">
                    <h4 className="font-medium text-white mb-2">Our Web Application Security Assessment includes:</h4>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                        <span className="text-muted-foreground">OWASP Top 10 vulnerability scanning</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                        <span className="text-muted-foreground">Authentication & session review</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
                        <span className="text-muted-foreground">Security header analysis</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-5 w-5 text-teal mr-2 mt-0.5 flex-shrink-0" />
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div className="space-y-4 lg:w-1/2">
                <h2 className="text-3xl md:text-4xl font-bold text-white">Ready to secure your web application?</h2>
                <p className="text-muted-foreground text-lg">
                  Subscribe to our fractional cybersecurity team and get expert web application security assessment and
                  advice.
                </p>
              </div>
